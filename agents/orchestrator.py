...
from tools.vision_tool import extract_text, analyze_image
...
7. "analyze_image": {"filepath": "<path>", "question": "<question>"} - Analyzes a photo, schematic, or engineering drawing.
